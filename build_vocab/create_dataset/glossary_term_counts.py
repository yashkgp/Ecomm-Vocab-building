        ...
        with open (os.path.join(path, name)) as json_file:
            ...
            try :
                ...
                if len(unicode_content)==0 :
                    continue
                if (gloss_count_ratio(unicode_content,1)):#>MINIMUM_OCCUR):
                ...
                try:
                    ...
                    if len(unicode_content)==0 :
                        continue
                    if (gloss_count_ratio(unicode_content)):#>MINIMUM_OCCUR):
                        sent=split_sent.tokenize((unicode_content).encode('ascii','ignore') )
...
with open('terms_count_gloss_100K.txt', 'w') as outfile:
